...
let make = () => {
  ...
  let myStyle = ReactDOMRe.Style.make(~fill="#" ++ themes[theme].valueColor, ~width="11px", ~cursor="pointer", ~marginLeft="5px", ());
  <svg style=myStyle xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    <g>
      <g>
