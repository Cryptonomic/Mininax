    ...
    <div className=Styles.mainContainer(theme) onClick={stop}>
      <div className=Styles.borderContainer>
        <div className=Styles.contentContainer>
          <div className=Styles.title>{ReasonReact.string("Select a Network")}</div>
          ...
          <button className=Styles.okBtn(theme) onClick={confirm}>{ReasonReact.string("Ok")}</button>
        </div>
      </div>
    </div>
